...
export default class App extends Component<Props> {
  ...
  randomVietnamPhoneNumber() {
    const phone = `09${this.randomNumber()}${this.randomNumber()}${this.randomNumber()}${this.randomNumber()}${this.randomNumber()}${this.randomNumber()}${this.randomNumber()}${this.randomNumber()}`;
    return {
      label: 'mobile',
      number: phone,
    };
